export const idlFactory = ({ IDL }) => {
  ...
  const Result_23 = IDL.Variant({ 'ok' : Contact, 'err' : CreateContactError });
  ...
  const Result_22 = IDL.Variant({ 'ok' : Product, 'err' : CreateProductError });
  ...
  const Result_17 = IDL.Variant({ 'ok' : IDL.Null, 'err' : DeleteOrderError });
  ...
  const Result_13 = IDL.Variant({ 'ok' : Category, 'err' : GetCategoryError });
  const GetContactError = IDL.Variant({
    'UserNotAdmin' : IDL.Null,
    'ContactNotFound' : IDL.Null,
    'UserNotAuthenticated' : IDL.Null,
  });
  const Result_12 = IDL.Variant({ 'ok' : Contact, 'err' : GetContactError });
  const GetProductError = IDL.Variant({ 'ProductNotFound' : IDL.Null });
  const Result_10 = IDL.Variant({ 'ok' : Product, 'err' : GetProductError });
  ...
  const Result_9 = IDL.Variant({ 'ok' : User, 'err' : GetUserError });
  const GetVariantError = IDL.Variant({ 'VariantNotFound' : IDL.Null });
  const Result_8 = IDL.Variant({ 'ok' : Variants, 'err' : GetVariantError });
  ...
  const Result_5 = IDL.Variant({ 'ok' : Contact, 'err' : UpdateContactError });
  ...
  return IDL.Service({
    'addtoCartItems' : IDL.Func([IDL.Text, IDL.Nat8], [Result_26], []),
    'addtoWishlist' : IDL.Func([IDL.Text], [Result_25], []),
    'createCategory' : IDL.Func([IDL.Text, ImgId], [Result_24], []),
    'createContact' : IDL.Func([UserContact], [Result_23], []),
    ...
    'deleteCartItems' : IDL.Func([CartId], [Result_20], []),
    'deleteCategory' : IDL.Func([SlugId], [Result_19], []),
    'deleteContact' : IDL.Func([ContactId], [Result_18], []),
    'deleteOrder' : IDL.Func([OrderId], [Result_17], []),
    'deleteProduct' : IDL.Func([SlugId], [Result_16], []),
    'deleteWishlistItems' : IDL.Func([WishlistId], [Result_15], []),
    'deletevariant' : IDL.Func([SlugId], [Result_14], []),
    'getCallerCartItems' : IDL.Func(
        [],
        [IDL.Vec(IDL.Tuple(CartId, CartItem))],
        ['query'],
      ),
    'getCategory' : IDL.Func([SlugId], [Result_13], ['query']),
    'getContact' : IDL.Func([ContactId], [Result_12], ['query']),
    'getOrder' : IDL.Func([IDL.Text], [Result_11], ['query']),
    'getProduct' : IDL.Func([SlugId], [Result_10], ['query']),
    'getUserdetailsbycaller' : IDL.Func([], [Result_9], ['query']),
    'getUserdetailsbyid' : IDL.Func([IDL.Principal], [Result_9], ['query']),
    'getvariant' : IDL.Func([SlugId], [Result_8], []),
    ...
    'updateCartItems' : IDL.Func([CartId, IDL.Nat8], [Result_7], []),
    'updateCategory' : IDL.Func([SlugId, IDL.Text, ImgId], [Result_6], []),
    'updateContact' : IDL.Func([ContactId, IDL.Bool], [Result_5], []),
